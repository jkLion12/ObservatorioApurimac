...
@Component({
  selector: 'app-detalle-infografia',
  standalone: true,
  ...
  templateUrl: './detalle-infografia.component.html',
  styleUrl: './detalle-infografia.component.css'
})
export class DetalleInfografiaComponent {
